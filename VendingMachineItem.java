...
public class VendingMachineItem {
	...
	//Exception message for when the name is given is null.
	private final static String NAME_ITEM_IS_NULL = "The name of the item cannot be null.";
	...
	public VendingMachineItem( String name, double price ) throws VendingMachineException {
		if(name==null) {
			throw new VendingMachineException(NAME_ITEM_IS_NULL);
		}
		this.name = name;
		if( price < 0 ) {
